...
export const featuredProjects: NFTProject[] = [
  {
    ...
    tasks: [
      { id: "1", title: "Follow on Twitter", completed: false, type: "twitter_follow" },
      { id: "2", title: "Join Discord Community", completed: false, type: "discord_join" },
      { id: "3", title: "Share announcement post", completed: false, type: "twitter_retweet" }
    ]
  },
  {
    id: "2",
    ...
    tasks: [
      { id: "1", title: "Follow on Twitter", completed: false, type: "twitter_follow" },
      { id: "2", title: "Join Discord Server", completed: false, type: "discord_join" }
    ]
  },
  {
    id: "3",
    ...
    tasks: [
      { id: "1", title: "Follow on Twitter", completed: false, type: "twitter_follow" },
      { id: "2", title: "Join Discord", completed: false, type: "discord_join" }
    ]
  },
  {
    id: "4",
