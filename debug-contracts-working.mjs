// Working debug script for staking contracts
  ...
  try {
    ...
    try {
      ...
      if (stakingToken.toLowerCase() !== NFT_CONTRACT.toLowerCase()) {
        ...
        console.log('   Expected:', NFT_CONTRACT);
    ...
    // Test with a sample wallet (from error logs)
    ...
    try {
      ...
      console.log('   Rewards:', ethers.utils.formatEther(stakeInfo[1]), 'ETH');
    } catch (error) {
