...
-- ============================================================================
-- Error: column reference "total_neft_earned" is ambiguous
-- Root Cause: Variable name conflicts with table column name
-- Solution: Use table aliases and qualified column references
-- ============================================================================
...
BEGIN
  ...
  -- Update user streaks with qualified column references
  ...
  -- Update user_balances table with qualified references
...
BEGIN
    ...
    RAISE NOTICE '- Added table aliases (us, user_balances)';
    RAISE NOTICE '- Used qualified column references';
    RAISE NOTICE '- Resolved total_neft_earned ambiguity';
    RAISE NOTICE '- Resolved total_xp_earned ambiguity';
    RAISE NOTICE 'Daily claims should now work without ambiguity errors!';
END $$;
