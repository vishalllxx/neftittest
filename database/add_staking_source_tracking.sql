...
ADD COLUMN IF NOT EXISTS staking_source TEXT 
...
-- Note: Existing records will have NULL staking_source until explicitly updated
-- This allows tracking of actual staking source without assumptions
