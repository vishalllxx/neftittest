-- Deploy script to fix onchain NFT tracking functions
-- This script drops existing functions and recreates them with fixes

-- Drop existing functions first
DROP FUNCTION IF EXISTS sync_onchain_nfts_to_collection(text, jsonb[]);
DROP FUNCTION IF EXISTS get_comprehensive_nft_counts(text);
