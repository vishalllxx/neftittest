-- ============================================================================
-- FIX AMBIGUOUS COLUMN REFERENCE: total_neft_earned
-- ============================================================================
-- Fixes the "column reference 'total_neft_earned' is ambiguous" error
-- by properly qualifying column references in the process_daily_claim function
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE 'Ambiguous column fix deployed. Test result: success=%, message=%', 
...
SELECT 'FIXED: Ambiguous column reference resolved!' as status,
       'All column references properly qualified with table names' as result;
