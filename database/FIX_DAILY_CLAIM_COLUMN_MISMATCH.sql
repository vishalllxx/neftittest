-- ============================================================================
-- FIX DAILY CLAIM COLUMN MISMATCH - SIMPLE VERSION
-- ============================================================================
-- Issue: process_daily_claim tries to set "updated_at" but table has "last_updated"
-- Solution: Fix the function to use existing column names
-- ============================================================================
...
BEGIN
  ...
  -- Update user streaks (REMOVED updated_at reference)
  ...
  -- Update user_balances table (uses last_updated)
...
DO $$
BEGIN
    RAISE NOTICE 'DAILY CLAIM COLUMN MISMATCH FIXED!';
    RAISE NOTICE 'Fixed: Removed updated_at reference from user_streaks update';
    RAISE NOTICE 'Uses: existing last_updated column in user_balances table';
    RAISE NOTICE 'Daily claims should now work without column errors!';
END $$;
