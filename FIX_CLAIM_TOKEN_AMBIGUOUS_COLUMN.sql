-- ============================================================================
-- FIX: Ambiguous Column Reference "available_neft" in claim_token_rewards_supabase_safe
-- ============================================================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ Fixed ambiguous column reference in claim_token_rewards_supabase_safe';
    ...
    RAISE NOTICE '🎯 Token reward claiming should now work without errors';
END $$;
