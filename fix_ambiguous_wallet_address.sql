-- Fix ambiguous wallet_address column reference in distribution functions
-- This addresses the "column reference 'wallet_address' is ambiguous" error

-- Step 1: Fix distribute_unique_nft function with proper parameter naming
...
-- Step 2: Fix mark_cid_as_distributed_safe function with proper parameter naming
